...
ds4-agent: ds4_agent.o ds4_help.o ds4_web.o ds4_kvstore.o lobster_tool.o linenoise.o $(CORE_OBJS)
	$(CC) $(CFLAGS) -o $@ ds4_agent.o ds4_help.o ds4_web.o ds4_kvstore.o lobster_tool.o linenoise.o $(CORE_OBJS) $(METAL_LDLIBS)

cpu: ds4_cli_cpu.o ds4_server_cpu.o ds4_bench_cpu.o ds4_eval_cpu.o ds4_agent_cpu.o ds4_help.o ds4_web.o ds4_kvstore.o lobster_tool.o linenoise.o rax.o $(CPU_CORE_OBJS)
	...
	$(CC) $(CFLAGS) -o ds4-agent ds4_agent_cpu.o ds4_help.o ds4_web.o ds4_kvstore.o lobster_tool.o linenoise.o $(CPU_CORE_OBJS) $(LDLIBS)
...
ds4_agent.o: ds4_agent.c ds4.h ds4_ssd.h ds4_distributed.h ds4_help.h ds4_kvstore.h ds4_web.h lobster_tool.h linenoise.h
	$(CC) $(CFLAGS) -c -o $@ ds4_agent.c

ds4_web.o: ds4_web.c ds4_web.h
	$(CC) $(CFLAGS) -c -o $@ ds4_web.c

lobster_tool.o: lobster_tool.c lobster_tool.h
	$(CC) $(CFLAGS) -c -o $@ lobster_tool.c
